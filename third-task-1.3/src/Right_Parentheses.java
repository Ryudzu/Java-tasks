...
public class Right_Parentheses {
    ...
    public static void main(String[] args) {
        ...
        // В качесте помощника в генерации числового выражения с правыми скобками будет выступать очередь generator.
        ...
        // Так как последнюю пару не нужно окутывать лишней правой скобкой, то значение pairs нужно уменьшить на единицу,
        ...
        for (int i = 0; i < initial_expression.length(); i++) {
            ...
            // Если же символом строки является левая скобка (')'), то уже в этом случае идет взаимодействовие со стеками.

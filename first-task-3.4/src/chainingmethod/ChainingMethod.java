...
public class ChainingMethod {
    ...
    /*
        ...
        То есть каждая ячейка массива имеет ссылку на следующий элемент в этой ячейке, это и есть принцип создания хеш-таблицы методом цепочек.
    ...
    */
    ...
    // Метод, при помощи которого создается хеш-таблица, чей принцип работы описан выше.
...
// Создание класса HashNode, на котором основан принцип работы LinkedList, данный класс будет необходим для реализации хеш-таблицы

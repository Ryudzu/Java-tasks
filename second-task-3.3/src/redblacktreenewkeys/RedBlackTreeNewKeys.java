package redblacktreenewkeys;

import java.util.logging.Level;
import java.util.logging.Logger;

public class RedBlackTreeNewKeys {

    private static final Logger logger = Logger.getLogger(RedBlackTreeNewKeys.class.getName());
    ...
    public static void main(String[] args) {
        RedBlackTreeNewKeys tree = new RedBlackTreeNewKeys();

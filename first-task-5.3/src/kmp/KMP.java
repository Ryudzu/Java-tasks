...
public class KMP {
    ...
    // Алгоритм Кнута — Морриса — Пратта (КМП-алгоритм). Данный алгоритм позволяет определить, существует ли такая подстрока в переданной
    ...
    // и подстроки 'ab'. Это нужно для того, чтобы в случае несовпадений не перемещаться в самое начало подстроки, а лишь в ту часть самой
    // строки, где нужно произвести сравнения. Таким образом и происходит поиск.

package redblacktreefromatok;

import java.util.logging.Level;
import java.util.logging.Logger;

public class RedBlackTreeFromAtoK {

    private static final Logger logger = Logger.getLogger(RedBlackTreeFromAtoK.class.getName());
    ...
    public static void main(String[] args) {
        RedBlackTreeFromAtoK tree = new RedBlackTreeFromAtoK();
